...
const Register = () => {
    ...
    const sendOtp = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post("https://emarket-xivk.onrender.com/user/verify", { email: form.email });
            setOtpSent(true);
      ...
      const UserRegister = async (e) => {
            ...
            try {
                const res = await axios.post("https://emarket-xivk.onrender.com/user/register", form);
